...
export default {
  ...
  async mounted() {
    ...
    var ws = new Date(
      new Date(currentDate).setDate(currentDate.getDate() - lessDays)
    );
    ...
    this.range1 = [
      new Date(
        parseInt(this.defaultWeekStart.split("-")[0]),
        parseInt(this.defaultWeekStart.split("-")[1]),
        parseInt(this.defaultWeekStart.split("-")[2])
      ),
      new Date(
        parseInt(this.defaultWeekEnd.split("-")[0]),
        parseInt(this.defaultWeekEnd.split("-")[1]),
        parseInt(this.defaultWeekEnd.split("-")[2])
      )
    ];
  }, 
  methods: {
